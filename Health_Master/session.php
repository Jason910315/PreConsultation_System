<?php
  ...
  $sql = "SELECT * FROM patient 
   ...
   $sql_query = "INSERT INTO symptom(symptom_ssid) VALUES('$ssid')";
  mysqli_query($db_link, $sql_query);
  
  
  $sql_query2 = "INSERT INTO record(sssid) VALUES('$ssid')";
  $data = mysqli_query($db_link, $sql_query2);
  
   mysqli_query($db_link, "SET CHARACTER SET UTF8");  //不加中文會出現亂碼 
...
<br>
  ...
  <table class="table-bordered" style="border:3px #009E9E solid;" border="3"  cellpadding="4" width="30%" >
    ...
    <form  id="body" name="body" method="post" action="neck.php">
            <input type="hidden" name="ssid" id="ssid" value="<?php echo $ssid; ?>" maxlength="10">
            <input type="hidden" name="action" value="add">
    ...
    <form id="neck" name="neck" method="post" action="body.php">
            <input type="hidden" name="ssid" id="ssid" value="<?php echo $ssid; ?>" maxlength="10">
            <input type="hidden" name="action" value="add">
