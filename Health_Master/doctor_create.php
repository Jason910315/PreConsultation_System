...
if (! (empty($_POST['ssid']))) {
  ...
  $symptom = mysqli_fetch_assoc($data);
    ...
    $sql_findID4 = "SELECT * FROM predict WHERE symptom_name = '".$symptom['symptom1']."'";
  ...
  $_SESSION['pediction'] = $predict['prediction'];
  //header('Location: welcome.php');
  header('Location: doctor_create.php');
}
?>
<html>
<head>
...
<html>
<body>
<form action="doctor_result.php" method="POST" id="result">
  <table class="table-bordered" style="border:3px #0066CC solid;" border="5" align="center" cellpadding="4" width="40%" >
...
<br>
 <tr><td bgcolor='#FFFFF2'><font size="5"><b><center>
<input type="submit" value="查看結果" name="查看結果" style="width:100px;height:30px;font-size:20px;border:none;font-weight:bold;color:white;background-color:#0066CC;"></center></td></tr>
</form>
</body>
