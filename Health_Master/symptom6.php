<?php
  ...
  $seldb = mysqli_select_db($db_link, "hospital")  
    or die("資料庫選擇失敗！");
  if (! (empty($_POST['ssid']))||empty($_POST['symptom1'])) {
  include('connectMySQL.php');
}
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $symptom_arr = array();
    $symptom_arr = $_POST['symptom6'];
    $symptom6 = implode(',', $symptom_arr);
  ...
  $symptom = mysqli_fetch_assoc($data);
    ...
    $sql_query = "UPDATE symptom SET symptom6=('$symptom6')  WHERE symptom_ssid='$ssid'";
