...
if (! (empty($_POST['ssid']))) {
  ...
  $_SESSION['pediction'] = $predict['prediction'];
   header('Location: finish_search.php');
...
<form action="finish_result.php" method="POST" id="result">
...
<input type="submit" value="查看結果" name="查看結果" style="width:100px;height:30px;font-size:20px;border:none;font-weight:bold;color:white;background-color:#008F8F;"></center></td></tr>
