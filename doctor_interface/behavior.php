...
<form action="symptom6.php" method="POST" id="formAdd">
  <table class="table-bordered" style="border:3px #009E9E solid;" border="5" align="center" cellpadding="4" width="35%" >
    <tr>
    ...
    <input type="checkbox" name="symptom6[]" value="易怒/易興奮"/>易怒/易興奮<br>
    <input type="checkbox" name="symptom6[]" value="情緒起伏大"/>情緒起伏大<br>
    <input type="checkbox" name="symptom6[]" value="時常憂鬱"/>時常憂鬱<br>
    <input type="checkbox" name="symptom6[]" value="焦慮"/>焦慮<br>
    <input type="checkbox" name="symptom6[]" value="經期異常"/>經期異常<br>
    <input type="checkbox" name="symptom6[]" value="酗酒"/>酗酒<br><br>
    </div></form></table>
    <br>
    <!-- 送出按鈕 -->
