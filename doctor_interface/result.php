...
<b><div class="navbar"><center>
  ...
  <a class="active" href="#"><i class="fa fa-pencil-square-o"></i> 病患資料</a>
...
<body>
  ...
  <table class="table-bordered" style="border:3px #009E9E solid;" border="3"  cellpadding="4" width="30%" >
    <tr>
      <td bgcolor='#FFFFF2'><font size="5"><b><center>欄位名稱</center></td>
      <td bgcolor='#FFFFF2'><font size="5"><b><center>資料內容</center></td>
    </tr>
    <tr>
...
<br>
    <a href="<?php echo $href?>"><input type="submit" value="觀看疾病衛教資訊" name="觀看疾病衛教資訊" 
    style="width:175px;height:30px;font-size:20px;border:none;font-weight:bold;color:white;background-color:#008F8F;text-align:center"></a>
