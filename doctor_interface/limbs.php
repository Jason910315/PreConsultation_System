...
<form action="symptom4.php" method="POST" id="formAdd">
  <table class="table-bordered" style="border:3px #009E9E solid;" border="5" align="center" cellpadding="4" width="32%" >
    <tr>
   ...
   <input type="hidden" name="ssid" id="ssid" value="<?php echo $ssid;?>" maxlength="10">
    <input type="checkbox" name="symptom4[]" value="手腳冰冷"/>手腳冰冷
    <input type="checkbox" name="symptom4[]" value="四肢無力"/>四肢無力
    <input type="checkbox" name="symptom4[]" value="四肢腫脹"/>四肢腫脹<br>
    <input type="checkbox" name="symptom4[]" value="舉止僵硬"/>舉止僵硬
    <input type="checkbox" name="symptom4[]" value="肌肉無力"/>肌肉無力
    <input type="checkbox" name="symptom4[]" value="肌肉流失"/>肌肉流失<br>
    <input type="checkbox" name="symptom4[]" value="下肢靜脈曲張"/>下肢靜脈曲張<br>
    <input type="checkbox" name="symptom4[]" value="血管腫脹"/>血管腫脹 (註：異常明顯的青筋)<br>
    <input type="checkbox" name="symptom4[]" value="髖關節疼痛 "/>髖關節疼痛 (註：大腿外展困難)<br>
    <input type="checkbox" name="symptom4[]" value="關節處腫脹"/>關節處腫脹
    <input type="checkbox" name="symptom4[]" value="關節疼痛"/>關節疼痛
    <input type="checkbox" name="symptom4[]" value="膝蓋痛"/>膝蓋痛<br>
    <input type="checkbox" name="symptom4[]" value="行走困難"/>行走困難
    <input type="checkbox" name="symptom4[]" value="步態不穩"/>步態不穩
    <input type="checkbox" name="symptom4[]" value="指甲發炎"/>指甲發炎<br><br>
    </div></form></table>
    <br>
    <!-- 送出按鈕 -->
