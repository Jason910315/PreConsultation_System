...
<form id="doctor_create.php" name="session" method="post" action="doctor_create.php">
<div>
  <table class="table-bordered" style="border:5px #0066CC solid;" border="5" align="center" cellpadding="4" width="30%" > 
    <tr><td align="center" bgcolor='#0066CC'><font size="5" color='white'><b>欄位名稱</b></td><td align="center" bgcolor='#0066CC'><font size="5" color='white'><b>資 料 內 容</b></td></tr>
      ...
      <input type="submit" name="button" id="button" value="查詢" style="width:100px;height:30px;font-size:20px;border:none;font-weight:bold;color:white;background-color:#0066CC;">
      </td>
    </tr>
    </table>
</div>
