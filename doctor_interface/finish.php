...
<b><div class="navbar"><center>
  ...
  <a class="input.php" href="#"><i class="fa fa-pencil-square-o"></i> 症狀填答</a>
  <a href="show.php"><i class="fa fa-id-card-o"></i> 候診看版</a>
    <a class="active" href="#"><i class="fa fa-calendar-check-o"></i>診斷結果</a>
...
<form id="finish_search.php" name="session" method="post" action="finish_search.php">
<div>
