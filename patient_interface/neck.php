...
<form action="symptom2.php" method="POST" id="formAdd">
  <table class="table-bordered" style="border:3px #009E9E solid;" border="5" align="center" cellpadding="4" width="42%" >
    <tr>
    ...
    <input type="checkbox" name="symptom2[]" value="喉嚨痛"/>喉嚨痛
    <input type="checkbox" name="symptom2[]" value="喉嚨有痰"/>喉嚨有痰<br>
    <input type="checkbox" name="symptom2[]" value="喉嚨有斑"/>喉嚨有斑 (註：伴隨喉嚨痛，舌頭尾端出現紅斑)<br>
    <input type="checkbox" name="symptom2[]" value="甲狀腺腫大"/>甲狀腺腫大 (註：脖子異常腫大，導致吞嚥及呼吸困難)<br>
    <input type="checkbox" name="symptom2[]" value="脖子僵硬"/>脖子僵硬
    <input type="checkbox" name="symptom2[]" value="脖子痠痛"/>脖子痠痛
    <br><br></div></form></table>
    <br>
    <!-- 送出按鈕 -->
